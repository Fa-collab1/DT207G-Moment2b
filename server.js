...
app.get("/workexperience/edit/:id", (req, res) => {
    ...
    let errormessage = newFunction(error);
...
function renderSingleWorkExperience(id, res, errormessage) {
...
function renderWorkExperienceList(res, errormessage) {
